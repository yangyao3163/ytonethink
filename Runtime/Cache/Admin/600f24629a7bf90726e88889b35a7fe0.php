...
<body>
	...
	<form action="<?php echo U();?>" method="post" class="form-horizontal">
		...
		<div class="form-item">
			<label class="item-label">电话<span class="check-tips">（用于显示的文字）</span></label>
			<div class="controls">
		...
		<div class="form-item">
			<label class="item-label">问题<span class="check-tips">（详细描述报修问题）</span></label>
			<div class="controls textarea input-large">
				<textarea name="problem"><?php echo ((isset($info["problem"]) && ($info["problem"] !== ""))?($info["problem"]):''); ?></textarea>
			</div>
		</div>
		<div class="form-item">
